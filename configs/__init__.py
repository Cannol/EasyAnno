...
# VIDEO_TARGET_SELECTOR_CONFIG_FILE = file_exists(os.path.join(CONFIGS_DIR, 'dataset_for_each', '15.yaml'))
...
ATTRIBUTE_SET_FILE = file_exists(os.path.join(CONFIGS_DIR, 'attributes_settings.yaml'))
